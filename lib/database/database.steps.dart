...
final class Schema2 extends i0.VersionedSchema {
  ...
  @override
  late final List<i1.DatabaseSchemaEntity> entities = [plans, gymSets];
...
final class Schema3 extends i0.VersionedSchema {
  ...
  late final Shape2 plans = Shape2(
    source: i0.VersionedTable(
      ...
      isStrict: false,
      tableConstraints: [],
      columns: [_column_0, _column_8, _column_1, _column_2],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
final class Schema4 extends i0.VersionedSchema {
  ...
  late final Shape3 plans = Shape3(
    source: i0.VersionedTable(
      ...
      isStrict: false,
      tableConstraints: [],
      columns: [_column_0, _column_8, _column_1, _column_2, _column_9],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
final class Schema18 extends i0.VersionedSchema {
  ...
  late final Shape12 planExercises = Shape12(
    source: i0.VersionedTable(
      ...
      isStrict: false,
      tableConstraints: [],
      columns: [_column_0, _column_40, _column_41, _column_42, _column_19],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
final class Schema19 extends i0.VersionedSchema {
  ...
  late final Shape3 plans = Shape3(
    source: i0.VersionedTable(
      ...
      isStrict: false,
      tableConstraints: [],
      columns: [_column_2, _column_1, _column_0, _column_8, _column_9],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  late final Shape12 planExercises = Shape12(
    source: i0.VersionedTable(
      ...
      isStrict: false,
      tableConstraints: [],
      columns: [_column_42, _column_41, _column_0, _column_19, _column_40],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
final class Schema45 extends i0.VersionedSchema {
  ...
  late final Shape34 plans = Shape34(
    source: i0.VersionedTable(
      ...
      isStrict: false,
      tableConstraints: [],
      columns: [_column_2, _column_0, _column_8, _column_9],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
i1.GeneratedColumn<String> _column_146(String aliasedName) =>
    i1.GeneratedColumn<String>(
      ...
      defaultValue: const i1.CustomExpression('\'bottom\''),
    );
...
i1.GeneratedColumn<int> _column_150(
  String aliasedName,
) => i1.GeneratedColumn<int>(
...
final class Schema53 extends i0.VersionedSchema {
  ...
  late final Shape44 settings = Shape44(
    source: i0.VersionedTable(
      entityName: 'settings',
      withoutRowId: false,
      isStrict: false,
...
i1.GeneratedColumn<String> _column_156(String aliasedName) =>
    i1.GeneratedColumn<String>(
      ...
      defaultValue: const i1.CustomExpression('\'underline\''),
    );
...
final class Schema55 extends i0.VersionedSchema {
  Schema55({required super.database}) : super(version: 55);
  @override
  late final List<i1.DatabaseSchemaEntity> entities = [
    plans,
    gymSets,
...
final class Schema56 extends i0.VersionedSchema {
  Schema56({required super.database}) : super(version: 56);
  @override
  late final List<i1.DatabaseSchemaEntity> entities = [
    plans,
    gymSets,
...
class Shape45 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<double> get reps =>
      columnsByName['reps']! as i1.GeneratedColumn<double>;
  i1.GeneratedColumn<double> get repDuration =>
      columnsByName['rep_duration']! as i1.GeneratedColumn<double>;
  i1.GeneratedColumn<int> get restMs =>
      columnsByName['rest_ms']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get unit =>
      columnsByName['unit']! as i1.GeneratedColumn<String>;
...
i1.GeneratedColumn<double> _column_157(String aliasedName) =>
    i1.GeneratedColumn<double>(
      'rep_duration',
      aliasedName,
      false,
...
final class Schema57 extends i0.VersionedSchema {
  ...
  late final Shape46 planExercises = Shape46(
    source: i0.VersionedTable(
      entityName: 'plan_exercises',
      withoutRowId: false,
      isStrict: false,
...
class Shape46 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get sequence =>
      columnsByName['sequence']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<double> get incrementWeight =>
      columnsByName['increment_weight']! as i1.GeneratedColumn<double>;
  i1.GeneratedColumn<double> get incrementReps =>
      columnsByName['increment_reps']! as i1.GeneratedColumn<double>;
  i1.GeneratedColumn<double> get incrementDuration =>
      columnsByName['increment_duration']! as i1.GeneratedColumn<double>;
}
...
i0.MigrationStepWithVersion migrationSteps({
  ...
  required Future<void> Function(i1.Migrator m, Schema55 schema) from54To55,
  ...
  return (currentVersion, database) async {
    switch (currentVersion) {
      ...
      case 53:
        ...
        return 54;
      case 54:
        final schema = Schema55(database: database);
        final migrator = i1.Migrator(database, schema);
        await from54To55(migrator, schema);
        return 55;
      case 55:
        final schema = Schema56(database: database);
        final migrator = i1.Migrator(database, schema);
        await from55To56(migrator, schema);
        return 56;
      case 56:
        final schema = Schema57(database: database);
        final migrator = i1.Migrator(database, schema);
        await from56To57(migrator, schema);
        return 57;
      default:
