...
class CategoriesData extends DataClass implements Insertable<CategoriesData> {
  ...
  CategoriesData copyWith({int? id, String? name}) =>
      CategoriesData(id: id ?? this.id, name: name ?? this.name);
...
class Settings extends Table with TableInfo<Settings, SettingsData> {
  ...
  notificationPermissionRequested = GeneratedColumn<int>(
    ...
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT 0 CHECK (notification_permission_requested IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  ...
  late final GeneratedColumn<int> showBodyWeight = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (show_body_weight IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
  late final GeneratedColumn<int> showCategories = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (show_categories IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
  ...
  late final GeneratedColumn<int> scrollableTabs = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (scrollable_tabs IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
  ...
  late final GeneratedColumn<int> showGraphLimit = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (show_graph_limit IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
  ...
  late final GeneratedColumn<int>
  defaultGraphTimeBasedXAxis = GeneratedColumn<int>(
  ...
  late final GeneratedColumn<int> keepScreenOn = GeneratedColumn<int>(
    'keep_screen_on',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<String> inputStyle = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT \'underline\'',
    defaultValue: const CustomExpression('\'underline\''),
  );
  @override
  List<GeneratedColumn> get $columns => [
    alarmSound,
...
class SettingsData extends DataClass implements Insertable<SettingsData> {
  ...
  final int notificationPermissionRequested;
  final int peekGraph;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['notification_permission_requested'] = Variable<int>(
      notificationPermissionRequested,
    );
    ...
    map['default_graph_time_based_x_axis'] = Variable<int>(
      defaultGraphTimeBasedXAxis,
    );
    map['keep_screen_on'] = Variable<int>(keepScreenOn);
  ...
  factory SettingsData.fromJson(
    ...
    return SettingsData(
      ...
      explainedPermissions: serializer.fromJson<int>(
      ...
      notificationPermissionRequested: serializer.fromJson<int>(
      ...
      defaultGraphTimeBasedXAxis: serializer.fromJson<int>(
        json['defaultGraphTimeBasedXAxis'],
      ),
      keepScreenOn: serializer.fromJson<int>(json['keepScreenOn']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'notificationPermissionRequested': serializer.toJson<int>(
        notificationPermissionRequested,
      ),
      ...
      'defaultGraphTimeBasedXAxis': serializer.toJson<int>(
        defaultGraphTimeBasedXAxis,
      ),
      'keepScreenOn': serializer.toJson<int>(keepScreenOn),
  ...
  SettingsData copyWith({
    ...
    int? maxSets,
    int? notifications,
    int? notificationPermissionRequested,
    int? peekGraph,
    String? planTrailing,
    int? repEstimation,
    int? restTimers,
...
class SettingsCompanion extends UpdateCompanion<SettingsData> {
  ...
  final Value<int> notificationPermissionRequested;
  ...
  static Insertable<SettingsData> custom({
    ...
    Expression<int>? notificationPermissionRequested,
  ...
  SettingsCompanion copyWith({
    ...
    Value<int>? notificationPermissionRequested,
    Value<int>? peekGraph,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (keepScreenOn.present) {
      map['keep_screen_on'] = Variable<int>(keepScreenOn.value);
    }
...
class PlanExercisesData extends DataClass
  ...
  factory PlanExercisesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class GraphPreferences extends Table
    with TableInfo<GraphPreferences, GraphPreferencesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  GraphPreferences(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> name = GeneratedColumn<String>(
    'name',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> timeBasedXAxis = GeneratedColumn<int>(
    'time_based_x_axis',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT 0 CHECK (time_based_x_axis IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  late final GeneratedColumn<String> notes = GeneratedColumn<String>(
    'notes',
  ...
  @override
  GraphPreferencesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return GraphPreferencesData(
      name: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}name'],
      )!,
  ...
  @override
  GraphPreferences createAlias(String alias) {
    return GraphPreferences(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(name, category)'];
  @override
  bool get dontWriteConstraints => true;
}

class GraphPreferencesData extends DataClass
    implements Insertable<GraphPreferencesData> {
  final String name;
  final String category;
  final String metric;
  final String period;
  final int limit;
  final int timeBasedXAxis;
  final String? notes;
  const GraphPreferencesData({
    required this.name,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['time_based_x_axis'] = Variable<int>(timeBasedXAxis);
    if (!nullToAbsent || notes != null) {
      map['notes'] = Variable<String>(notes);
    }
    return map;
  ...
  factory GraphPreferencesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return GraphPreferencesData(
      ...
      timeBasedXAxis: serializer.fromJson<int>(json['timeBasedXAxis']),
      notes: serializer.fromJson<String?>(json['notes']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'timeBasedXAxis': serializer.toJson<int>(timeBasedXAxis),
      'notes': serializer.toJson<String?>(notes),
    };
  }

  GraphPreferencesData copyWith({
    String? name,
    String? category,
    String? metric,
    String? period,
  ...
  GraphPreferencesData copyWithCompanion(GraphPreferencesCompanion data) {
    return GraphPreferencesData(
      name: data.name.present ? data.name.value : this.name,
      category: data.category.present ? data.category.value : this.category,
  ...
  @override
  String toString() {
    return (StringBuffer('GraphPreferencesData(')
          ..write('name: $name, ')
          ..write('category: $category, ')
          ..write('metric: $metric, ')
          ..write('period: $period, ')
...
class GraphPreferencesCompanion extends UpdateCompanion<GraphPreferencesData> {
  final Value<String> name;
  final Value<String> category;
  final Value<String> metric;
  final Value<String> period;
  final Value<int> limit;
  final Value<int> timeBasedXAxis;
  final Value<String?> notes;
  final Value<int> rowid;
  ...
  static Insertable<GraphPreferencesData> custom({
    Expression<String>? name,
    Expression<String>? category,
    Expression<String>? metric,
    Expression<String>? period,
    Expression<int>? limit,
    Expression<int>? timeBasedXAxis,
    Expression<String>? notes,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (timeBasedXAxis.present) {
      map['time_based_x_axis'] = Variable<int>(timeBasedXAxis.value);
    }
    if (notes.present) {
      map['notes'] = Variable<String>(notes.value);
    }
...
class DatabaseAtV59 extends GeneratedDatabase {
  DatabaseAtV59(QueryExecutor e) : super(e);
  ...
  late final GraphPreferences graphPreferences = GraphPreferences(this);
  @override
