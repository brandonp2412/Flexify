...
class Settings extends Table with TableInfo<Settings, SettingsData> {
  ...
  SettingsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SettingsData(
      ...
      showHistoryTab: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}show_history_tab'],
      )!,
      showImages: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}show_images'],
      )!,
      showTimerTab: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}show_timer_tab'],
      )!,
